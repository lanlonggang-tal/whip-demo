...
const deleteRequest = (location) =>
  post(location, {
    method: "DELETE"
  });
const updateRequest = (location, config) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
class Publisher extends EventEmitter {
  ...
  unpublish() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (!this.location) {
        throw new Error(
          "Not in publishing. Consider using `publish()` before `unpublish()`."
        );
      }
  ...
  mute(muted, kind) {
    return __awaiter(this, void 0, void 0, function* () {
      if (!this.location) {
        throw new Error(
          "Not in publishing. Consider using `publish()` before `mute()`."
        );
      }
      if (kind === "audio" || !kind) {
